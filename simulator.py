...
def Correlation_inter_average_row(C_simu, C_ref, resolution, corr_function, theta, theta_corr_dict):
    """
    Input : 
...
def plot_C_genome(C, resolution, sig_2_ref, intensity_ref, centro):

...
import numpy as np
from simulator import get_num_beads_and_start, chr_seq_3_chr, chr_cen_3_chr
...
def vectorise_upper_matrix(C, resolution):
    ...
    first_bloc = 1
    for (chr_1, chr_2) in combinations(chr_seq_3_chr.keys(), r=2):
...
if 0:
    ...
    DNN = CNNEmbedding(input_shape=input_dim, in_channels=1, output_dim=output_dim, num_linear_layers=nb_hidden_layers, num_linear_units=1000, kernel_size=kernel_size, pool_kernel_size=pool_kernel_size)
